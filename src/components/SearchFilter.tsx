...
export default function SearchFilter() {
  return (
    <div className='flex flex-col md:flex-row gap-2 my-4'>
      ...
      <select className='bg-gray-50 border border-gray-300 text-gray-800 text-sm md:max-w-[200px] rounded-lg focus:border-blue-500 outline-none block w-full p-3'>
